================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Frm プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Frm には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Frm アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Frm.h
   ...
   CFrmApp アプリケーション クラスを宣言します。

Frm.cpp
   これは、アプリケーション クラス CFrmApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Frm.ico
   ...
   アイコンはメイン リソース ファイル Frm.rc に含まれていま
   す。
...
StdAfx.h, StdAfx.cpp
   ...
   Frm.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
